...
class HtmlFormatter(MessageFormatter):
    ...
    def generate_failed_notes_email(self, user_name: str, data: list) -> str:
        rows = ""
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                The system was unable to fetch notes for the following
                <strong>{len(data)}</strong> order(s).
            </p>
            ...
            <p style="margin-top:20px;">
                Please investigate these orders and retry fetching the notes if necessary.
                If the API or internet issue is temprary, than the issue will automatically resolve in next run of the program.
            </p>

        </div>

        <div class="footer">
            This is an automated notification generated by the ZED Order Processing System.
        </div>
